  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center w-full text-white">
      ...
      <p className="text-lg mb-4">I am a software engineer, writer, gamer (table-top and online), animal-lover, and life-long learner.
        I originally started programming long ago with BASIC on the ancient computer my family could afford back when I was 12 years old. 
        However, I then took a break from programming when I went to college to study history. While I loved history (and still do!) I
        decided to return to programming as I enjoyed the logic, creativity, and problem solving that came with it.
      </p>
      ...
      <p className="text-lg mb-4">
        ...
        larger corporations.  There I have utilized a wide range of technologies, including SQL (SQL Server and PostgreSQL mostly), C#, Java,
        jQuery, JavaScript, HTML, CSS, and more recently Vue.js, React, Next.js, Node.js, and TypeScript amongst others. For a little over
        the last five years I have been working mostly as a front-end developer. While I enjoy working on the front-end (and generally favor it),
        I also am comfortable working on the back-end, and I am currently refreshing my SQL skills and digging into Node.js 
