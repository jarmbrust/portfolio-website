  ...
  return (
    <div className="flex flex-col items-start w-full mb-12">
      ...
      <div className="w-full text-left text-lg ml-4">
        ...
        <p className="mb-2">   
          Beyond a demonstration of my development skills and a deep-dive into a few technologies I haven&apos;t taken the chance yet
          to really dig into, the app&apos;s purpose is to allow users the ability to create an account to login in with in order to write, 
          ...
          You will also be able to categorize those recipes, and search for them based on those categories, or individual ingredients. 
        ...
        <p className="mb-2">
          ...
          Other modifications will occur as I think of them, or they are suggested to me.
        </p>
        <p className="mb-2">
